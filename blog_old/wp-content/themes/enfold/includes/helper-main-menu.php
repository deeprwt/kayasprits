...
<header id='header' class='all_colors header_color <?php avia_is_dark_bg('header_color'); echo " ".$headerS['header_class']; ?><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">' <?php avia_markup_helper(array('context' => 'header','post_type'=>'forum'));?>>
