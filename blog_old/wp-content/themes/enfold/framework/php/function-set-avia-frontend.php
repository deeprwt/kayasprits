...
if(!function_exists('kriesi_backlink'))
{
	...
	{	
		...
		if($random_number % 3 == 0) $theme_string = $theme_name."";
		if($random_number % 3 == 1) $theme_string = $theme_name."";
		if($random_number % 3 == 2) $theme_string = "powered by ".$theme_name."";
		if(!empty($frontpage_only) && !is_front_page()) $no = "rel='nofollow'";
		
		$link = " | <a {$no} href='http://www.sorinwd.ir'>طراحی و توسعه وب سورین</a>";
