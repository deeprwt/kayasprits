<?php
	...
	if (isset($_POST['submit'])) {
		...
		$mail->addAddress('cmd@kayagroupindia.com');
...
.contact_detail {padding-bottom: 20px;}
...
<div id="hero" class="single-page section" style="background-image:linear-gradient(rgba(0,0,0,.8),rgba(0,0,0,.8)), url(images/slider/contact.jpg)">
    ...
    <div class="container">
        ...
        <div class="contact-grid">
            ...
            <h3>roop@kayagroupindia.com</h3>
            </div>
            <div class="col-sm-6 col-md-3 contact-grid1">
           
            <h4>All HR/admin related queries</h4>
            <h3>hrmanager@kayagroupindia.com</h3>
            </div>
            <div class="col-sm-6 col-md-3 contact-grid1">
            
            <h4>All Financials/Legal</h4>
            <h3>cmd@kayagroupindia.com</h3>
            </div>
            
            <div class="col-sm-6 col-md-3 contact-grid1">
            <h4>Feedback/Any Other Queries</h4>
            <h3>info@kayagroupindia.com</h3>
            </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid super-dark section no-padding" style="background-image:linear-gradient(rgba(0,0,0,.2),rgba(0,0,0,.2)), url(images/bg_back.jpg); background-size:cover">
	...
	<div class="row">
         ...
         <div class="col-md-4 col-sm-4 icon-grid">
          <ul class="contact-list ">
            ...
            <i class="fa fa-location-arrow"></i>
                ...
                Corporate Office:
                <span><b>Kaya Blenders & Distillers Limited</b><br>Mullanpur Road Village Hambran <br>District Ludhiana 140901</span>
                </div>
            </li>
            <!--<li>
        ...
        <div class="col-md-4 col-sm-4 icon-grid">
            ...
            <h4>Email</h4>
            <h3><span><a href="https://www.kayaspirits.com/cdn-cgi/l/email-protection" target="_blank" class="__cf_email__" data-cfemail="c7b4a6aba2b487a4b5a6a1b3a5a2a2b5eaa9a6b3aea8a9e9a4a8aa">[info@kayagroupindia.com]</a></span></h3>
        </div>
...
<section class="" style="padding:0px 15px 15px 15px">
<div class="contact_info">
                    ...
                    <div class="contact_detail">
                		<div id="contact_form"><br>
							...
							<form action="contact.php" method="post" name="google-sheet" class="clearfix" enctype="multipart/form-data">
							    <div id="form_alerts" style="text-align: center;"></div>
                            <div class="col-sm-6">
                        ...
                        <input class="input-text form-control" type="text" name="city" id="city" style="height: 36px;" placeholder="Your City *">
                    		...
                    		<input name="submit" class="input-btn" type="reset" value="Reset the form!" >
...
<script>
    ...
    <script>
        const scriptURL = 'https://script.google.com/macros/s/AKfycbwCBpIjUzBN1zmaCLHHjLmk0hTXQ_IfgnZ3kXsZ9Ny-fu6zJ1QmZr6A4V1piBDZEA5rlQ/exec'
    ...
    <!--
    <script>
            const scriptURL = 'https://script.google.com/macros/s/AKfycby2HQi463HB5rPxT_LnJe4p3v9E-vpEhHznBy4PVyTTbmAVNQBG0nE-vimOsQljVzIMMQ/exec'
            const form = document.forms['google-sheet']
          
            form.addEventListener('submit', e => {
              e.preventDefault()
              fetch(scriptURL, { method: 'POST', body: new FormData(form)})
                .then(response => alert("Thanks for choose Kaya Spirits"))
        ...
        const scriptURL =
            'https://script.google.com/macros/s/AKfycby2HQi463HB5rPxT_LnJe4p3v9E-vpEhHznBy4PVyTTbmAVNQBG0nE-vimOsQljVzIMMQ/exec'
        const form = document.forms['google-sheet']
        form.addEventListener('submit', e => {
            e.preventDefault()
            fetch(scriptURL, {
