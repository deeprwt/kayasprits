...
<body class="<?php echo $classesReturn; ?>">
	...
	<div class="top-area-btn-group">
		...
		<div class="top-area-btn left-menu-btn"><span class="dashicons dashicons-admin-generic"></span></div>
		...
		<div class="left-menu-sublist interface-settings">
			<ul>
				...
				<li class="basic"><a href="<?php echo admin_url("admin.php?page=yellow-pencil-changes"); ?>" target="_blank">Manage Customizations <span class="dashicons dashicons-external"></span></a></li>
	...
	(function($){
        ...
        <?php
        	...
        	if($comments == null || $comments == false){
        		...
        		echo "window.selectorComments = ".yp_stripslashes($comments).";";
        	}
		...
		$(document).ready(function(){
	        ...
	        $('#iframe').on('load', function(){
				...
				iframe.find("head").append(editorData.html().replace(/(^\<\!\-\-|\-\-\>$)/g, ""));
				editorData.remove();
				iframeBody.append('<div id="yp-animate-data">'+iframe.find("head").find("#yp-animate-data").html()+'</div>');
				iframe.find("head").find("#yp-animate-data").remove();
