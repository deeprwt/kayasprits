...
More amazing features available in [__Pro version__](https://aazztech.com/product/logo-carousel-slider-pro).
...
*   Display logo in your desired order with easy Drag & Drop functionality
...
= 1.4 =
* Major update to the slider code
* Implemented infinite loop 
* Improved performance
* Fixed some minor bugs  
= 1.3 =
* Fixed a border related issue
= 1.2 =
