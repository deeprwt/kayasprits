...
$p_dir='';
$use_captcha=false;
$send_to='website@kayaspirits.com';
$send_to_bcc='';
$forbid_urls=TRUE;
$page_encoding='UTF-8';
$re_upfields=array();
$re_fields=array('country','date_day','date_month','date_year');
...
$reply_from='website@kayaspirits.com';if($reply_from=='')$reply_from=$sendto_array[0];
$reply_subject="";
