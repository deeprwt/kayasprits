		...
		try {
			return this.each(function() {
				...
				if (options.autostart) {
					...
					//Joe: drag'n'drop implementation
					var $th = this;
					
		      $(this).parents('.fileuploader').on('drop', function(e) {
					...
					$(this).parents('.fileuploader').bind('drop', function(e, ui) {
						//$th.files = e.originalEvent.dataTransfer.files;
						upload.call($th,e);
					});
					//Joe: end of drag'n'drop
				}
				var $that=$(this);
