...
.popupoption2:hover{
  ...
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window">
    <div id="lorem">
      ...
      <p style="padding:10px">Thank you for Career. You are very important to us, all information received will always remain confidential. We will contact you as soon as we review your message.</p>
    </div>
    <div id="popupfoot"> <a href="http://www.kayaspirits.com/en/career.php" class="agree">OK</a> </div>
  </div>
...
<script src="js/loadpopup.js"></script>
