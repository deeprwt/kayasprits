...
<div id="hero" class="single-page section" style="background-image:linear-gradient(rgba(0,0,0,.8),rgba(0,0,0,.8)), url(images/contact.jpg)">
...
<div class="container-fluid super-dark section no-padding" style="background-image:linear-gradient(rgba(0,0,0,.2),rgba(0,0,0,.2)), url(images/bg_back.jpg); background-size:cover">
	...
	<div class="row">
        ...
        <div class="col-md-4 col-sm-4 icon-grid">
            ...
            <h4>Email</h4>
            <h3><span><a href="https://www.kayaspirits.com/cdn-cgi/l/email-protection" target="_blank" class="__cf_email__" data-cfemail="c7b4a6aba2b487a4b5a6a1b3a5a2a2b5eaa9a6b3aea8a9e9a4a8aa">[info@kayaspirits.com]</a></span></h3>
        </div>
