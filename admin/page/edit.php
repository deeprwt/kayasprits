...
?>
 <table width="100%"  cellpadding="0" cellspacing="0"  border="0" >
  <tr><td valign="top" height="35" align="left" class="td_heading1">Edit <?php echo $data['Title']; ?> Detail</td></tr>
  </table>
        ...
        <tr >
          <td height="15" colspan="2"  align="center" ><b>New Page Details</b> </td>
            ...
            <tr class="gridcell">
                    ...
                    <td  align="right" height="20" class="gridhead">Company Name<font color="red">*</font>&nbsp;</td>
          <td  align="left"> <input name="Name" type="text" class="textfield" id="Name" size="35" value="<?php echo $data['Name'] ;?>">  
		           </td>
        </tr>
 <input name="Id" type="hidden" class="textfield" value="<?php echo $_GET['Id'] ;?>">
...
?> 
 ...
 <tr class="gridcell">
                    ...
                    <td  align="right" height="20" class="gridhead">Title</font>&nbsp;</td>
          <td  align="left"> <input name="SeoTitle" type="text" class="textfield"   value="<?php echo getData( $data['SeoTitle'] )?>" size="60">         </td>
        </tr >
  ...
  <tr class="gridcell">
   ...
   <tr class="gridcell">
          ...
          <td  align="left"> <input name="SeoDesc" type="text" class="textfield"   value="<?php echo getData( $data['SeoDesc'] )?>" size="60">         </td>
        </tr >
